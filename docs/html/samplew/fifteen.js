...
window.onload = function() {
	...
	var p2 = document.createTextNode("Finding Nemo");
	...
	back1.onclick = function() {
		for ( var t = 0; t < 15; t++) {
			document.getElementsByTagName("body")[0].style.backgroundImage="url(originalback.jpg)";
			puzzlearea[t].style.backgroundImage = "url(background.jpg)";
		}
	}
	back2.onclick = function() {
		for ( var t = 0; t < 15; t++) {
			document.getElementsByTagName("body")[0].style.backgroundImage="url(originalback.jpg)";
			puzzlearea[t].style.backgroundImage = "url(background2.jpg)";
		}
	}
	back3.onclick = function() {
		for ( var t = 0; t < 15; t++) {
			document.getElementsByTagName("body")[0].style.backgroundImage="url(originalback.jpg)";
			puzzlearea[t].style.backgroundImage = "url(background3.jpg)";
		}
	}
	back4.onclick = function() {
		for ( var t = 0; t < 15; t++) {
			document.getElementsByTagName("body")[0].style.backgroundImage="url(originalback.jpg)";
			puzzlearea[t].style.backgroundImage = "url(background4.jpg)";
		}
	}
}
